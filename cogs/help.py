...
PAVLOV_COMMANDS = {
    "Player": [
        ...
        ("custom", "\"Command args\" [Servername]", "Sends a raw RCON command (admin only)"),
    ],
    "Server": [
        ("serverinfo", "[Servername]", "Returns server info (map, mode, score, players)"),
        ("refreshlist", "[Servername]", "Lists all connected players and their UniqueIDs"),
        ("inspectall", "[Servername]", "Returns status for all players"),
        ("rotatemap", "[Servername]", "Rotates to the next map in the rotation"),
    ...
    "Moderation": [
        ...
        ("moderatorlist", "[Servername]", "Lists all moderators"),
        ("banlist", "[Servername]", "Lists all banned players"),
        ...
        ("itemlist", "[Servername]", "Lists all available items"),
    ],
    "TTT": [
